...
PHRASE_SYMBOLS_LATEX = AND + AT + BAR + BACKSLASH + COLON + COMMA + DASH + DOLLAR + DOUBLE_QUOTE + EQUAL + EXCLAMATION + GREATER + HASH + HAT + LESS + MINUS + PERIOD + PLUS + QUOTE + SLASH + STAR + TILDE + PAREN_OPEN + PAREN_CLOSE + PERCENTAGE + QUESTION_MARK + UNDERSCORE
