...
\begin{note}[Equivalence of Turing machines]
...
\begin{note}[No transition out of accepting and rejecting states]
...
\begin{important}[A Turing machine uses a tape]
...
\begin{definition}[A TM accepting or rejecting a string]
...
\begin{important}[Turing machines can loop forever]
...
\begin{exercise}[Practice with configurations]
...
\begin{exercise}[A simple decidable language]
...
\begin{exercise}[Drawing TM state diagrams]
...
\begin{important}[The Church-Turing Thesis]
...
\begin{note}[Low-level, medium-level, high-level descriptions of TMs]
...
\begin{note}[Encodings of machines]
...
\begin{important}[Checking the input type]
...
\begin{exercise}[Decidability is closed under intersection and union]
...
\begin{exercise}[Decidable language based on pi]
...
\begin{definition}[Languages related to encodings of DFAs]
...
\begin{theorem}[$\text{ACCEPTS-DFA}$ and $\text{SELF-ACCEPTS-DFA}$ are decidable]
...
\begin{theorem}[$\text{EMPTY-DFA}$ is decidable]
...
\begin{theorem}[$\text{EQ-DFA}$ is decidable]
...
\begin{important}[Decidability through reductions]
...
\begin{exercise}[Practice with decidability through reductions]
