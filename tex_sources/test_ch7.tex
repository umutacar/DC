...
\begin{example}[A graph with $6$ vertices and $4$ edges]
...
\begin{important}[Representations of graphs]
...
\begin{exercise}[Max number of edges in a graph]
...
\begin{definition}[Neighborhood of a vertex]
...
\begin{example}[Example of neighborhood and degree]
...
\begin{exercise}[Application of Handshake Theorem]
...
\begin{definition}[Connected graph, connected component]
...
\begin{theorem}[Min number of edges to connect a graph]
...
\begin{definition}[Tree, leaf, internal node]
...
\begin{exercise}[Equivalent definitions of a tree]
...
\begin{exercise}[A tree has at least 2 leaves]
...
\begin{exercise}[Max degree is at most number of leaves]
...
\begin{note}[Root, parent, child, sibling, etc.]
...
\begin{note}[Drawing directed graphs]
...
\begin{definition}[Neighborhood, out-degree, in-degree, sink, source]
...
\begin{note}[Paths and cycles in directed graphs]
...
\begin{definition}[Arbitrary-first search (AFS) algorithm]
...
\begin{note}[Traversing all the vertices in the graph]
...
\begin{definition}[Breadth-first search (BFS) algorithm]
...
\begin{note}[Running time of BFS]
...
\begin{definition}[Depth-first search (DFS) algorithm]
...
\begin{note}[Running time of DFS]
...
\begin{note}[Search algorithms on directed graphs]
...
\begin{definition}[Minimum spanning tree (MST) problem]
...
\begin{note}[Unique edges costs imply unique MST]
...
\begin{theorem}[Jarn\'{i}k-Prim algorithm for MST]
...
\begin{exercise}[MST with negative costs]
...
\begin{exercise}[Maximum spanning tree]
...
\begin{exercise}[Kruskal's algorithm]
