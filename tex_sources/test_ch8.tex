...
\begin{definition}[Matching -- maximum, maximal, perfect]
...
\begin{example}[Examples of matchings]
...
\begin{exercise}[Number of perfect matchings in a complete graph]
...
\begin{example}[Augmenting path example 2]
...
\begin{note}[Edge cases for augmenting paths]
...
\begin{theorem}[Characterization for maximum matchings]
...
\begin{exercise}[Graphs with max degree at most 2]
...
\begin{exercise}[A tree can have at most one perfect matching]
...
\begin{example}[Bipartite graph example]
...
\begin{definition}[$k$-colorable graphs]
...
\begin{example}[A 3-colorable graph]
...
\begin{note}[2-colorability is equivalent to bipartiteness]
...
\begin{theorem}[Finding a maximum matching in bipartite graphs]
...
\begin{note}[Finding a maximum matching in non-bipartite graphs]
...
\begin{corollary}[Characterization of bipartite graphs with perfect matchings]
...
\begin{note}[Hall's Theorem when the two parts have equal size]
...
\begin{exercise}[Practice with perfect matchings]
