...
\begin{gram}[Reducing \MCSS{} to \MCSSS{} and \MCSSE{}]
...
\begin{algorithm}[An Optimal Alggorithm for \MCSSS{}]
...
\begin{flex}
\label{grp:alg:mcss::dc::first::bestacross}
...
\begin{cluster}
\label{grp:grm:mcss::prove}

\begin{gram}
\label{grm:mcss::prove}
