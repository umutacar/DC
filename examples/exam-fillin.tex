...
\ask vertex A \sols discovery: \fin{1} and  finish: \fin{2}. 
\\
\ask vertex B \sols discovery: \fin{2}  and  finish: \fin{7}.
\\
\ask vertex C \sols discovery: \fin{3} and finish: \fin{6}.
\\
\ask vertex D \sols discovery: \fin{4} and finish:  \fin{5}.
\\
\ask vertex E \sols discovery: \fin{18} and finish: \fin{11}.
\\
\ask vertex F \sols discovery:  \fin{9} and finish: \fin{10}.
\end{problem}
