...
\begin{problem}[True/False Miscellaneous]
...
\begin{problem}[5p][Shortest Weighted]
...
%\newpage
%\input{../../../dfs/enterExit}
\begin{problem}[5p][Enter and Exit]
 \used{Fall 14, Practice Exam II}
...
\begin{problem}[4p][Parallel Cycle Detection]
\ask
...
%
\begin{problem}[6p][Star Contraction]
\ask
