...
Here is a quick check on understanding:
Above why did we assume X

\begin{xchoice}
\choice Because we could not assume Y.
\choice* If we didn't, then we would have ... contradicting...
\end{xchoice}
...
\begin{gram}[20][Problem gram with xchoice I.1]
\depend{quiz::ii::1::1}
