...
%% IMPORTANT [August 2018]: This should be the same as
%% ../template/210-pandoc.py This is here for historical reasons:
%% dex-to-mlx translation scripts use this.  It should be deprecated
%% in the future.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% PACKAGES
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%\def\targethtml{}
%% Diderot automatically defines \targethtml
...
\newcommand{\download}[2]{\href{#1}{#2}}

(* Diderot command: attach *)
\newcommand{\attach}[2]{\href{#1}{#2}}
