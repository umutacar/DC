...
\begin{itemize}
\item  \ref{TB/sec:bg::graphs::basics}
\item \ref{TB/ex:bg::graphs::basics::examples}
\item \ref{TB/def:bg::graphs::basics::enumerable}
\item \ref{TB/sec:bg::graphs::weighted}
\end{itemize}

Here are some local references: 
\begin{itemize}
\item \ref{sec:sets::math}
\item \ref{adt:sets} 
\item \ref{syn:sets}
\end{itemize}
