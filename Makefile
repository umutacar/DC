...
OCB_FLAGS = -use-ocamlfind -package re2 -package core -I english -I tex -I xml -I pervasives 
OCB = ocamlbuild $(OCB_FLAGS)
DEPEND = \
  english/english_words.ml \
  pervasives/utils.ml pervasives/error_code.ml \
  tex/mdSyntax.ml tex/tex_ast.ml tex/tex_labels.ml tex/tex_lexer.mll tex/tex_parser.mly tex/tex2html.ml tex/tex_syntax.ml tex/preprocessor.ml \
