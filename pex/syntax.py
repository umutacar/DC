...
## pex/syntax.py
##
## This file offers pandoc-friendly definitions and utilities
## that are used to translate DeX files into LaTeX.
##
## The main difference from "Standard" LaTeX is that 
## pandoc-friendly latex does not use environments.
## Because environments are not supported by pandoc.
## Instead we use paragraph headings.
######################################################################
